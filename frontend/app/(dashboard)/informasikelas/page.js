...
const Tabel = ( ) => {
    return (
         <div className="flex flex-col justify-center p-[5vh]   w-[90vw]">
              <div className="flex justify-between w-full p-[2vh]"> <h1 className="font-bold text-3xl">Informasi Kelas sumthin</h1> <motion.button 
          ...
          <table className=" rounded-lg overflow-hidden">
            <thead>
              <tr className="bg-[#0B3869] text-white">
                ...
                <th className="px-4 py-3 text-left font-semibold">Orang Tua/Walit</th>
                <th className="px-4 py-3 text-left font-semibold">Input Kegiatan</th>
                <th className="px-4 py-3 text-left font-semibold">Presensi</th>
